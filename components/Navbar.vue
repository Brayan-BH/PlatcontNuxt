            ...
            <div class="container__item">
                ...
                <nav id="id-menu" class="item__menu" :class="[interaction.movil_menu_open ? 'open' : '']">
                    ...
                    <div class="li__container">
                        <button type="button" class="li-container__button">Productos
                        </button>
                ...
                <li class="ul__li">
                    <div class="li__container">
                        <button type="button" class="li-container__button">Recursos </button>
                        <ul class="li-container__menu">
                            <li class="">
                                <ul class="menu__body">
                                    <li class="body__item">
                        ...
                        <li class="ul__li">
                            <nuxt-link to="/productos" class="li__text">Productos</nuxt-link>
                        </li>
                        <li class="ul__li">
